 ...
 * Constructor
 *
 * @param constructorOptions see communicationOptions.constructor
 * @constructor
 */
...
function CommunicationApi(constructorOptions) {
    ...
    this.options = new communicationOptions.constructor(constructorOptions);
 ...
 *
 * @param originalOptions see communicationOptions.auth
...
CommunicationApi.prototype.auth = function(originalOptions, callback) {
    ...
    try {
        ...
        options = new communicationOptions.auth(originalOptions);
 ...
 *
 * @param originalOptions see communicationOptions.getRequest
...
CommunicationApi.prototype.getRequest = function(originalOptions, callback) {
    ...
    try {
        ...
        options = new communicationOptions.getRequest(originalOptions);
