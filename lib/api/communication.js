...
define(deps, function(communicationOptions, communicationErrors,commonErrors,
RequestApi, ResponseApi, preauthUtil, util, merge){
...
CommunicationApi.prototype.auth = function (originalOptions, callback) {
    ...
    var requestOptions = window.merge({}, options);
    console.log("AQUI " + requestOptions)
