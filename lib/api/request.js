 ...
 * Constructor for API
 *
 * @param options see RequestOptions.constructor
 * @constructor
 */

function RequestApi(options) {

    this.options = new requestOptions.constructor(options);
 ...
 *
 * @param options see RequestOptions.addRequest
 * @param callback Callback to run when requests are added
 */

RequestApi.prototype.addRequest = function(options, callback) {

    try {

        options = new requestOptions.addRequest(options);
